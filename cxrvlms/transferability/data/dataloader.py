...
def get_dataloader_splits(dataframe_path, data_root_path, targets, shots_train="80%", shots_val="0%", norm=False,
                          shots_test="20%", balance=False, batch_size=8, num_workers=0, seed=0, size=224):
    ...
    val_loader = get_loader(data_val, transforms, "val", batch_size, num_workers)
    test_loader = get_loader(data_test, transforms, "test", batch_size, num_workers)
